...
module.exports = {
  ...
  appHtmlBrowsers: resolveApp("public/browsers.ejs"),
  appIndex: resolveModule(resolveApp, "src/web/Index"),
  appIndexLibrary: resolveModule(resolveApp, "src/web/IndexLibrary"),
  appFavicon: resolveApp("src/assets/images/favicon.png"),
