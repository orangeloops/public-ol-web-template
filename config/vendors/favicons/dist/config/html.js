...
module.exports = {
  ...
  appleStartup: [
    // LevelUp
    // https://stackoverflow.com/a/57338818
    //
  ...
  favicons: [
    ({ relative }) => `<link id="favicon" rel="shortcut icon" href="${relative("favicon.ico")}">`,
    ...
    ({ relative }) => `<link id="favicon-dark-16x16" rel="icon" type="image/png" sizes="16x16" href="${relative("favicon-dark-16x16.png")}">`,
    ({ relative }) => `<link id="favicon-dark-32x32" rel="icon" type="image/png" sizes="32x32" href="${relative("favicon-dark-32x32.png")}">`,
    ({ relative }) => `<link id="favicon-dark-48x48" rel="icon" type="image/png" sizes="48x48" href="${relative("favicon-dark-48x48.png")}">`
    //
  ],
  windows: [
